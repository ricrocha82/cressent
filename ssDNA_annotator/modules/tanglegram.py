...
def generate_tanglegram(tree1, tree2, label1, label2, output_dir, name_tanglegram="tanglegram.pdf", width=20, height=11):
    """
...
def main():
    ...
    # run R script
    generate_tanglegram(args.tree1, args.tree2, args.label1, args.label2, args.output, name_tanglegram=args.name_tanglegram, width=args.width, height=args.height)
