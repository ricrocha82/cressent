...
def align_sequences(input_fasta, output_dir, mafft_ep=0.123, threads=1):
    """
...
def main():
    ...
    # Run the pipeline
    aligned_fasta = align_sequences(input_fasta, output_dir, mafft_ep=args.mafft_ep, threads=args.threads)
    trimmed_fasta = trim_alignment(aligned_fasta, output_dir, gap_threshold=args.gap_threshold)
